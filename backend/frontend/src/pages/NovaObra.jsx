...
export default function NovaObra() {
  ...
  async function handleSubmit(e) {
    ...
    if (obraEditada === true) { setError('Obras já editadas por outras editoras não podem ser cadastradas.'); return }
    if (!termosAceitos)  { setError('Você precisa aceitar os Termos de Uso.'); return }
    if (!contratoAceito) { setError('Você precisa assinar o Contrato de Edição.'); return }
    ...
    try {
      ...
      form.append('contrato_aceito', 'true')
      form.append('obra_editada',    'false')
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button type="submit" className="btn btn-primary"
            disabled={loading || !termosAceitos || !contratoAceito || obraEditada !== false}>
